...
export default function Page() {
  ...
  const downloadImage = async (url: string, filename: string) => {
    try {
      // Show loading indicator or notification here if desired
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#E6F7FF] dark:bg-[#0A1A2A] transition-colors duration-300">
